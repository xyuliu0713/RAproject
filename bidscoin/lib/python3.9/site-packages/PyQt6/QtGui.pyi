...
class QUtiMimeConverter(PyQt6.sip.simplewrapper):
    ...
    def convertToMime(self, mime: typing.Optional[str], data: collections.abc.Iterable[typing.Union[QtCore.QByteArray, bytes, bytearray, memoryview]], uti: typing.Optional[str]) -> typing.Any: ...
    def mimeForUti(self, uti: typing.Optional[str]) -> str: ...
    def utiForMime(self, mime: typing.Optional[str]) -> str: ...
    def convertFromMime(self, mime: typing.Optional[str], data: typing.Any, uti: typing.Optional[str]) -> list[QtCore.QByteArray]: ...
